...
export function TodoList() {
    ...
    const toggleTodo = (todoId, completed) => setTodos(currentTodos => currentTodos.map(todo => (todo.id === todoId ? { ...todo, completed } : todo))); // only ensure the new item's complete attribute is set to false (default), keep rest of items unchanged
